...
namespace InfraEstrutura.Data.Seed
{
    public static class DataSeeder
    {
        public static async Task SeedAsync(ApplicationDbContext context, CancellationToken cancellationToken = default)
        {
            await SeedPessoasAsync(context, cancellationToken);
            await SeedProdutosAsync(context, cancellationToken);
        ...
        private static async Task SeedPessoasAsync(ApplicationDbContext context, CancellationToken cancellationToken)
        {
            if (await context.Pessoas.AnyAsync(cancellationToken))
            {
                return;
            }
            ...
            await context.Pessoas.AddRangeAsync(pessoas, cancellationToken);
        }

        private static async Task SeedProdutosAsync(ApplicationDbContext context, CancellationToken cancellationToken)
        {
            ...
            await context.Produtos.AddRangeAsync(produtos, cancellationToken);
        }
    }
}
