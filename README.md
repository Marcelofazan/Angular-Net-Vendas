## 🌐 Angular-Vendas-Api10
Exemplo de projeto API com Arquitetura CQRS-like de Vendas com Serilog e idempotência em Angular 17 e C# ASP.NET Core 10 EF com banco de dados Postgres. 
